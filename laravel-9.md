...
@todo one to many :
- https://stackoverflow.com/questions/56201094/laravel-many-to-many-and-one-to-many-table-model-and-controller
- https://masteringbackend.com/posts/laravel-one-to-many-relationships-with-crud-example
- https://www.tutsmake.com/laravel-one-to-many-relationship-example/
@todo many to many :
- https://stackoverflow.com/questions/56201094/laravel-many-to-many-and-one-to-many-table-model-and-controller
...
- https://www.tutsmake.com/laravel-8-bootstrap-auth-scaffolding-example/
...
@todo faire un diagramme de séquence qui décrit le traitement des requêtes et l'envoi de réponses
...
@todo model [Eloquent: Relationships - Laravel - The PHP Framework For Web Artisans](https://laravel.com/docs/8.x/eloquent-relationships)
@todo requêtes de sélection, d'insertion, mise à jour et suppression avec eloquent
@todo routes de formulaire de création (create, store), contrôleur de formulaire de création, template de formulaire de création
@todo routes de formulaire de modification (edit, update), contrôleur de formulaire de modification, template de formulaire de modification
@todo routes de sélection liste (index), contrôleur de sélection liste, template de sélection liste
@todo routes de sélection détail (show), contrôleur de sélection détail, template de sélection détail
@todo routes de suppression (destroy), contrôleur de suppression
@todo traduction [Getting Started | Laravel Lang](https://laravel-lang.com/) [Laravel Lang Publisher | Laravel Lang Publisher](https://publisher.laravel-lang.com/)
...
old method
[How To Use Command "php Artisan Make:auth" In Laravel 8 - EsaleUp](https://esaleup.com/development/laravel/how-to-use-command-php-artisan-makeauth-in-laravel-8/)
...
[Laravel changes in php artisan ui:auth php artisan make:auth | by Panjeh | Medium](https://panjeh.medium.com/laravel-changes-in-php-artisan-ui-auth-php-artisan-make-auth-82fdb8893726)
